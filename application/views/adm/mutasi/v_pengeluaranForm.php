...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="gridSystemModalLabel">Pengeluaran Baru (<?php echo "kode mutasi <i>".$kode1."</i>";?>)</h4>
</div>

<form method="POST" action="<?php echo site_url();?>/administrator/c_mutasi/pengeluaranAddSave">
    <input class="form-control" type="hidden" id="pIdMutasi" name="pIdMutasi" value="<?php echo $kode1;?>"/>
