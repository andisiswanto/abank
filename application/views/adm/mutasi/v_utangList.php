    ...
    <body>
        ...
        <script>
            ...
            function cekDetail(kode){
                $.post("<?= site_url() ?>/administrator/c_mutasi/utangDetail", {
                    kode : kode
                },
                function(data) {
                    $('#isiModal').html(data);
            ...
            function edit(kode){
                $.post("<?= site_url() ?>/administrator/c_mutasi/utangEdit", {
                    kode : kode
                },
                function(data) {
                    $('#isiModal').html(data);
            ...
            function add(){
                $.post("<?= site_url() ?>/administrator/c_mutasi/utangAdd", {
                },
                function(data) {
                    $('#isiModal').html(data);
                    $('#detailModal').modal('show');
            ...
            function removeData(id,description){
                ...
                if (r==true)
                    window.location = url+"/administrator/c_mutasi/utangDelete?id="+id+"&desc="+description;
                else return false;
            }
