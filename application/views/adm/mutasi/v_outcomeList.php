        ...
        <div  id="page" class="container theme-showcase" role="main">
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><button class="btn btn-success" id="add" onclick="add('<?php echo $kode_mutasi;?>')">ADD</button>
                        <i>limit pengeluaran </i><?php echo rupiah($total_pengeluaran);?>
                    </div>
                </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div id="row">
                                <div class="col-lg-12">
                                    <div id="mysecondchart" class="myclassy"></div>    
                                </div>
                            </div>  
                        </div>
                    </div>
                ...
                <div class="panel panel-warning ">
                    <div class="panel-heading">
                      <h3 class="panel-title">Panel Pengeluaran</h3>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
...
//                }
            ...
            function add(kode1){
                $.post("<?= site_url() ?>/administrator/c_mutasi/pengeluaranAdd", {
                    kode1 : kode1
                },
                function(data) {
                    $('#isiModal').html(data);
