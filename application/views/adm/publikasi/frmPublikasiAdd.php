...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="gridSystemModalLabel">Tambah Publikasi Baru</h4>
</div>
<form method="POST" action="<?php echo site_url();?>/administrator/c_publikasi/publikasiAddSave" enctype="multipart/form-data"> 
