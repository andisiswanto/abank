...
<form method="POST" action="<?php echo site_url();?>/administrator/c_profile/daerahAddSave">
<div class="row">
    <div class="col-md-7">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <input class="form-control" type="hidden" name="pKodeKota" value="<?php echo $kodekota;?>" />
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                <textarea class="form-control" id="editor1" name="pDeskripsi"></textarea>
            </div>
        </div>
    </div>
</div>
