...
<form method="POST" action="<?php echo site_url();?>/administrator/c_profile/visiEditSave">
<div class="row">
    <div class="col-md-7">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <input class="form-control" type="hidden" name="pKode" required="" value="<?php echo $kode;?>"/>
                <input class="form-control" type="text" name="pJudul" required="" value="<?php echo $judul;?>"/>
            </div>
        </div>
    </div>
    <div class="col-md-5">
