...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="gridSystemModalLabel">Ubah Nama File Data & Informasi</h4>
</div>
<form method="POST" action="<?php echo site_url();?>/administrator/c_info/infoRenameSave"> 
