...
<form method="POST" action="<?php echo site_url();?>/administrator/c_asoka/mutasiEditSave">
    ...
    <div class="modal-body"> 
        <div class="row">
            <div class="col-xs-6">
                ...
                <div class="form-group">
                    <label> (Dari/Ke) Rekening </label> 
                    <select class="form-control" id="pFromTo" name="pFromTo">
                        <option value="may" <?php if($fromto==="may"){?>selected=""<?php } ?>>MAY</option>
                        <option value="pepi" <?php if($fromto==="pepi"){?>selected=""<?php } ?>>PEPI</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-6">
