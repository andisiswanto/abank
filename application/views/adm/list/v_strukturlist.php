	...
	<head>
        ...
        <script>
            function cekDetail(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/strukturDetail", {
                    kode : kode
                },
                function(data) {
                    $('#isiModal').html(data);
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                foreach($tabel as $tbl){
                    $kode=$tbl->kode_struktur;
                    $judul=$tbl->judul_struktur;
                    ?>
                    <tr>
                        <td><?php echo $kode;?></td>
                        <td><?php echo $judul;?></td>
                        <td><button class="btn btn-info" id="detail" onclick="cekDetail('<?php echo $kode;?>')">DETAIL</button></td>
                    </tr>  
                    <?php
                }
                ?>
