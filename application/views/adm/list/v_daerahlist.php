	...
	<head>
        ...
        <script>
            function cekDetail(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/daerahDetail", {
                    kode : kode
                },
                function(data) {
                    $('#isiModal').html(data);
            ...
            function edit(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/daerahEdit", {
                    kode : kode
                },
                function(data) {
                    $('#page').html(data);
            ...
            function add(kodekota){
                $.post("<?= site_url() ?>/administrator/c_profile/daerahAdd", {
                    kodekota : kodekota
                },
                function(data) {
                    $('#page').html(data);
...
-->
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                foreach($tabel as $tbl){
                    $kodekota=$tbl->id_kota;
                    $kode=$tbl->id_pdaerah;
                    $nama_kota=$tbl->judul_pdaerah;
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info" id="detail" onclick="cekDetail('<?php echo $kode;?>')"> DETAIL </button>
        ...
        <button class="btn btn-success" id="add" onclick="add('<?php echo $kodekota;?>')">ADD</button>
