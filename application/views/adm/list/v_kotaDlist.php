...
<html>
	<head>
        ...
        <script>
            function cekNext(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/kotaDDetail", {
                    kode : kode
                },
                function(data) {
                    //$('#isiModal').html(data);
            ...
            function edit(kode){
                $.post("<?= site_url() ?>/administrator/admc_profile/visiEdit", {
                    kode : kode
                },
                function(data) {
                    $('#page').html(data);
            ...
            function add(){
                $.post("<?= site_url() ?>/administrator/c_profile/visiAdd", {
                },
                function(data) {
                    $('#page').html(data);
                    //$('#detailModal').modal('show');
            ...
            <tbody>
                ...
                foreach($tabel as $tbl){
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info" id="detail" onclick="cekNext('<?php echo $kode;?>')"> <?php echo ">>>";?> </button>
                            <!--<button class="btn btn-warning" id="edit" onclick="edit('<?php echo $nama_kota;?>')">EDIT</button>-->
                        </td>
                    </tr>  
                    <?php
                }
