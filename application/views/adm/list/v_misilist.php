	...
	<head>
        ...
        <script>
            function cekDetail(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/misiDetail", {
                    kode : kode
                },
                function(data) {
                    $('#isiModal').html(data);
            ...
            function edit(kode){
                $.post("<?= site_url() ?>/administrator/c_profile/misiEdit", {
                    kode : kode
                },
                function(data) {
                    $('#page').html(data);
            ...
            function add(){
                $.post("<?= site_url() ?>/administrator/c_profile/misiAdd", {
                },
                function(data) {
                    $('#page').html(data);
                    //$('#detailModal').modal('show');
