...
//            $data['backDir']=$backDir;
            ...
            $data['tabel']=$this->m_list->getListTabel('mst_provinsi','nama_provinsi','ASC');
            $this->load->view('adm/global/v_provinceList',$data);
	}
        public function showCityFromParent(){
            $parentId=$_POST['kode'];
            $this->load->view('adm/v_header');
            $data['tabel']=$this->m_list->getListTabelFromParent('mst_kota','id_provinsi',$parentId,'NAMA_KOTA','ASC');
            $this->load->view('adm/global/v_cityList',$data);
        }
